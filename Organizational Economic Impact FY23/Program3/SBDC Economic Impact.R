...
setwd("C:/Users/galsaifi/OneDrive - University of Nebraska at Omaha/NBDC/NBDC Projects/NBDC Economic Impact 2023/SBDC Clients")
dat <- read_xlsx("SBDC Ecnomic Impact 21-23.xlsx")
...
write_xlsx(dat, "SBDC Ecnomic Impact 21-23.xlsx")
...
# Export plot
# ggsave("SBDC Economic Impact 21-23.jpg", p, width = 22, height = 10, units = "in", dpi = 1500)
...
#write_xlsx(pie, "SBDC Pie Data.xlsx")
